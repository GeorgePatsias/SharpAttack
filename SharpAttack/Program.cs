...
namespace SharpAttack
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            catch { Console.WriteLine("Failed: ENVIRONMENTAL VARIABLES"); }
            ...
            catch { Console.WriteLine("Failed: ALL USER FOLDERS ACCESS"); }
            ...
            catch { Console.WriteLine("Failed: POWERSHELL VERSIONS"); }
            ...
            catch { Console.WriteLine("Failed: POWERSHELL HISTORY FILE"); }
            ...
            catch { Console.WriteLine("Failed: ANTIVURUS PROCESSES"); }
            ...
            catch { Console.WriteLine("Failed: EDR PRODUCTS"); }

            //WINDOWS DEFENDER CONFIGURATION AND EXCEPTIONS
            try
            {
            ...
            catch { Console.WriteLine("Failed: WINDOWS DEFENDER CONFIGURATION AND EXCEPTIONS"); }
            ...
            catch { Console.WriteLine("Failed: WINDOWS DEFENDER EXCLUSIONS"); }
            ...
            catch { Console.WriteLine("Failed: WINDOWS RECENT FILES"); }
            ...
            catch { Console.WriteLine("Failed: NETWORK CONNECTIONS"); }

            //CHECK FOR REGISTRY x64/x32
            try
            {
            ...
            catch { Console.WriteLine("Failed: CHECK FOR REGISTRY x64/x32"); }
            ...
            catch { Console.WriteLine("Failed: APPLOCKER ENUMERATION"); }
            ...
            catch { Console.WriteLine("Failed: POWERSHELL SCRIPT LOGGING ENUMERATION"); }
            ...
            catch { Console.WriteLine("Failed: POWERSHELL TRANSCRIPTION LOGGING"); }
            ...
            catch { Console.WriteLine("Failed: POWERSHELL CONSTRAINED MODES ENUMERATION"); }
            ...
            catch { Console.WriteLine("Failed: ATTACHED DRIVES"); }
            ...
            catch { Console.WriteLine("Failed: LAPS"); }
